...
public class JSONToXMLFunction extends BasicFunction {
	...
	public final static FunctionSignature J2X_SIGNATURE = new FunctionSignature(
		new QName("j2x", LunaticModule.NAMESPACE_URI, LunaticModule.PREFIX),
	...
	public Sequence eval(Sequence[] args, Sequence contextSequence) throws XPathException {
		...
		JSONLunaticFlatToXMLLunaticFlatTranslator translator = new JSONLunaticFlatToXMLLunaticFlatTranslator();
